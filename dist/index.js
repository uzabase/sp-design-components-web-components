...
class pe extends HTMLElement {
  set type(e) {
    p(this, m, "f").innerHTML = e in this.paths ? this.paths[e] : "";
  }
  set text(e) {
    p(this, m, "f").setAttribute("aria-label", e);
  }
  get size() {
    return p(this, y, "f");
  }
  set size(e) {
    ...
    p(this, m, "f").classList.remove(o[p(this, y, "f")]), p(this, m, "f").classList.add(o[e]), de(this, y, e, "f");
  }
  static get observedAttributes() {
    return ["type", "text", "size"];
  }
  constructor() {
    super(), y.set(this, "medium"), m.set(this, document.createElementNS("http://www.w3.org/2000/svg", "svg")), this.paths = {}, this.attachShadow({ mode: "open" }), this.size = "medium";
  }
  connectedCallback() {
    p(this, m, "f").setAttribute("role", "img"), p(this, m, "f").setAttribute("viewBox", "0 0 24 24"), p(this, m, "f").classList.add("icon"), this.shadowRoot.appendChild(p(this, m, "f"));
  }
  attributeChangedCallback(e, o, t) {
    if (o !== t)
      switch (e) {
...
y = /* @__PURE__ */ new WeakMap(), m = /* @__PURE__ */ new WeakMap();
...
const me = ["horizontal", "vertical"];
function be(i) {
  return me.some((e) => e === i);
}
...
class De extends HTMLElement {
  ...
  attributeChangedCallback(e, o, t) {
    o !== t && (e === "label" && this.#m(t), e === "open" && this.#C(t), e === "disabled" && this.#k(t), e === "position" && this.#y(t));
  }
  #m(e) {
    this.label = e;
  }
...
class st extends HTMLElement {
  ...
  #L(e, o, t) {
    ...
    const h = this.#p(e);
    return s.disabled = h, s.onclick = () => this.#m(t), s;
  }
  #x(e, o) {
...
customElements.get("sp-tag-link") || customElements.define("sp-tag-link", mt);
