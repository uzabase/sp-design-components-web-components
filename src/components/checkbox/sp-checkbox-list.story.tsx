...
import "./sp-checkbox-list.ts";

export default {
  title: "sp-checkbox-list",
  tags: ["autodocs"],
  render(params) {
    const el = document.createElement("sp-checkbox-list");
    ...
    params.indeterminate && el.setAttribute("indeterminate", params.indeterminate);
